...
from backend.app.core.database import managed_connection
from backend.app.core.security import generate_token, hash_password, utc_now_iso


DEFAULT_USER_EMAIL = 'admin@sqli-sentinel.local'
